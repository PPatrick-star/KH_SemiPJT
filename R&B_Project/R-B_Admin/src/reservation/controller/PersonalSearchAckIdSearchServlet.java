...
/**
 * Servlet implementation class PersonalSearchAckIdSearchServlet
 */
@WebServlet("/personal/search/ack/id")
public class PersonalSearchAckIdSearchServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PersonalSearchAckIdSearchServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PageData pageAckData = new ReservationService().personalSearchAckNaIdList(currentPage, search);
