...
/**
 * Servlet implementation class GroupSearchAckNameServlet
 */
@WebServlet("/group/search/ack/name")
public class GroupSearchAckNameServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GroupSearchAckNameServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PageData groupPageData = new ReservationService().groupAckNameSearchList(currentPage, search);
