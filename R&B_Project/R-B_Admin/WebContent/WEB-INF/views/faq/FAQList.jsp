		...
		<div id="wrapping2">
			...
			<section>
				...
				<div id="section_right">
					...
					<br> 	<input type="submit" onclick="location.href='/faq/writeForm?faqNo=${faq.faqNo}'" value="등록"><br> <br> <br>
					...
					<c:forEach items="${fList }" var="faq" varStatus="index">
						...
						<input type="submit" onclick="location.href='/faq/modifyForm?faqNo=${faq.faqNo}'" value="수정"><input type="submit" onclick="location.href='/faq/del?faqNo=${faq.faqNo}'"  value="삭제">
