		...
		<div id="wrapping2">
			...
			<section>
				<div id="section_left">
					...
					<div class="left_subNav"><a href="/personal/reservation" class="subA">개인예약</a></div>
					<div class="left_subNav"><a href="/group/reservation" class="subA">단체예약</a></div>
				</div>
				<div id="section_right">
					<div id="section_right_top"><%@ include file="groupReservationAcknowledgment.jsp" %></div>
					<div id="section_right_bottom"><%@ include file="groupReservationConfirm.jsp" %></div>
				</div>
