...
/**
 * Servlet implementation class OnLineConfirmServlet
 */
@WebServlet("/online/confirm")
public class OnLineConfirmServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public OnLineConfirmServlet() {
        super();
