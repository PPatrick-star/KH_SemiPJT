	...
	<div id="wrapping2">
		...
		<section>
			...
			<div class="todayBlood">
				...
				<a href="/reservation/info/agree"><img src="/images/물방울1.png" style="margin-top: 15px; margin-left: 50px; position: absolute;"></a>
				<div class="tbBox">
			...
			<div class="blCheck">
				...
				<a href="/ResList"><img src="/images/물방울1.png" style="margin-top: 15px; margin-left: 50px; position: absolute;"></a>
				<div class="bChkBox">
					<div class="blcBtn"><img src="/images/돋보기.png"><a href="/ResList" style="text-decoration: none; margin-left:15px;">헌혈기록 조회</a></div>
					<div class="blcBtn"><img src="/images/돋보기.png"><a href="/ResList" style="text-decoration: none; margin-left:15px;">검사결과 조회</a></div>
					<img src="/images/의료모니터.png" style="margin-left:80px; margin-top:20px; width: 150px;">
				</div>
			</div>
			...
			<div class="cheerUp">
				...
				<div class="cuBox">
					 <!-- <p style="display: blocks; heigth:100px; width:auto;"> -->
