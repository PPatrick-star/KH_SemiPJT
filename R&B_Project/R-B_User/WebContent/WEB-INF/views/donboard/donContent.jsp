         ...
         <section>
            ...
            <div id="section_right">
               ...
               <c:if test="${content.userId eq sessionScope.member.userId}" > 
                  ...
                  <input class="notBtn2" type="button" onclick="location.href='/donboard/modifyForm?dbNo=${content.dbNo }'" value="수정"></input> 
                  </c:if>
               <c:if test="${content.userId ne sessionScope.member.userId}" > 
                  <input class="notBtn" type="button" onclick="location.href='/donboard/list'" 
                     value="목록"></input>
               </c:if>
               </div>
               <br>
                                 ...
                                 <td>
                                    ...
                                    <form action="/donboard/commentDelete" method="get">
                                       <input type="hidden" name="dbNo"
                                          ...
                                          <c:if test="${comment.userId  eq sessionscope.sessionId}" > 
                                          <input
