				...
				<div id="section_right">
					...
					<form action="/cheer/write" method="post">
						<input id="reg_text" type="text" maxlength="30" name="content"
							size=120 placeholder="응원의 한마디를 입력해주세요~"> <input
							id="reg_btn" type="submit" value="등록" id="write_btn"> 
					</form>
					<br>
					<br>
					<table class="table">
						...
						<c:forEach items="${nList }" var="cheer" varStatus="index">
							<tr>
								...
								<td class="delete">
								<c:if test="${sessionScope.member != null && cheer.userId eq sessionScope.member.userId }">
									<input class="delBtn" onclick="location.href='/cheer/del?postNo=${cheer.cbNo}'" type="submit" value="삭제">
								</c:if>
								</td>
							</tr>
						</c:forEach>
