		...
		<div id="wrapping2">
			...
			<section>
				...
				<div id="section_right">
					...
					<!-- 버튼-->
					<div id="btn_div">
						<%-- <input type="button" onclick="location.href='/notice/delete?noticeNo=${content.noticeNo}'" value="삭제"></input> 
						<input type="button" onclick="location.href='/notice/modifyForm?noticeNo=${content.noticeNo}'" value="수정"></input> --%>
						<input class="notBtn" type="button" onclick="location.href='/notice/list'"
							value="목록"></input>
					</div>
