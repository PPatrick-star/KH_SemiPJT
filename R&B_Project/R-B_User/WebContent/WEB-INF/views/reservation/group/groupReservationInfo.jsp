...
<body>
	 <div id="right_wrapping">
                  ...
                  <form method="post" action="/group/reservation/info/input">
                     <div id="content">
                        <div id="content_sub">
                           <p style="font-weight:900; font-size:20px; text-align: center;"> ${sessionScope.member.userName } 님</p>
                           ...
                           <ul>
                              ...
                              <li>예약 인원<input type="number" name="people" onclick="peopleNum(this)" onchange="peopleNum(this)" required><br><br></li>
                              <li>장소 선택<input type="text" id="postCode" style="width:220px; display:inline-block;" placeholder="우편번호" name="postCode" readonly>
                                    <button id="addrSearchBtn" onclick="addSearch();">주소검색</button>
                                    <br>
                                    <input type="text" id="roadAddr"  style="margin-left : 105px; margin-top : 10px;" placeholder="도로명주소" name="roadAddr" required>
                                    <br>
                                    <input type="text" id="detailAddr"   style="margin-left : 105px; margin-top : 10px;"  placeholder="상세주소" name="detailAddr">
                              </li>
