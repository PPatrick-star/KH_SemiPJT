		...
		<div id="wrapping2">
			...
			<section>
				...
				<div id="section_right">
					...
					<!-- 버튼-->
					<div id="btn_div">
						<c:if test="${content.userId eq sessionScope.member.userId}" > 
							<input class="notBtn" type="button" onclick="location.href='/memboard/delete?mbNo=${content.mbNo }'" value="삭제"> 
							<input class="notBtn2" type="button" onclick="location.href='/memboard/modifyForm?mbNo=${content.mbNo }'" value="수정"> 
						</c:if>
						<c:if test="${content.userId ne sessionScope.member.userId}" > 
						<input class="notBtn" type="button" onclick="location.href='/memboard/list'" value="목록">
						</c:if>
					</div>
        			<br>
        <!-- 덧글 출력 폼 -->
											...
											<td>
												...
												<form action="/memboard/commentDelete" method="get">
													<input type="hidden" name="mbNo"
														value="${content.mbNo }">
														<input type="hidden"
														name="comNo" value="${comment.memNo}"> 
